            ...
            <Container style={Styles.containerStyle}>
                ...
                <Content contentContainerStyle={Styles.contentStyle}>
                    <View style={Styles.form}>
                        <Text style={Styles.title}>{strings.services}</Text>
                        <Text style={Styles.subtitle}>{strings.ourwork}</Text>
                        <Text style={Styles.titleDesc}>Jobs that have been completed for our satisfied</Text>
                        <Text style={Styles.itemTitle}>{strings.packaging_equipment}</Text>
                        <Text style={Styles.content}>
                            We provide service to Ohlson Pack Machines, VAI Machines, Bosh Machines, Tray Pack, Ultra Source Vacuum sealers. Complete overhauls and routine maintenance.
                        </Text>
                        <Text style={Styles.itemTitle}>{strings.metal_plating}</Text>
                        <Text style={Styles.content}>
                            We offer the following:
                        </Text>
                        <Text style={Styles.content}>
                            • Custom control Panels for DC Rectifiers
                        </Text>
                        <Text style={Styles.content}>
                            • Custom made Submersible Heat Exchange Coils
                        </Text>
                        <Text style={Styles.content}>
                        ...
                        <Text style={Styles.itemTitle}>{strings.mobileCanning}</Text>
                        <Text style={Styles.content}>
                            We are excited about this upcoming service. Follow us on Twitter or Facebook for updates.
                        </Text>
                    </View>
                    {this.renderProgress()}
                </Content>

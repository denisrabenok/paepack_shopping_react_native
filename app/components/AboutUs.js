                ...
                <Content contentContainerStyle={Styles.contentStyle}>
                    ...
                    <View style={Styles.form}>
                        <Text style={Styles.content}>
                            PAEPACK also known as PAE Packaging Specialized in Packaging Machines, VFFS-Vertical Form Film Seal, Supplies for Continuous band sealers, Custom made machinery, Mobile Canning Service Coming soon.
                        </Text>
                        <Text style={Styles.content}>
                            We are currently an online based company and ship our products within the United States.
                        </Text>
                        <TouchableOpacity style={[Styles.btn, { marginTop: width / 10 }]}>
                            <Text style={Styles.btnText}>{strings.shopParts}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={Styles.btn}>
                            <Text style={Styles.btnText}>{strings.shopServices}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={Styles.btn}>
                            <Text style={Styles.btnText}>{strings.portfolio}</Text>
                        </TouchableOpacity>
                    </View>
                    {this.renderProgress()}
                </Content>
